# PRD — phần phát triển Workspace Multi-Agent

> **Trạng thái:** Yêu cầu cho một release Workspace mở rộng; không thay thế phạm vi Personal Agent của đề bài gốc.
>
> **Owner:** Nhóm Multi-Agent
>
> **Cập nhật:** 2026-08-19
>
> **Release mục tiêu:** bản mở rộng Workspace nội bộ một công ty
>
> **Nguồn định hướng:** [Product Brief](BRIEF.md)
>
> **Nguồn thiết kế kỹ thuật:** [Architecture](ARCHITECTURE.md)
>
> **Nguồn trạng thái hiện hành:** [Development Report](DEVELOPMENT_REPORT.md)

## 1. Mục đích tài liệu

PRD này khóa nghiệp vụ, phạm vi, acceptance criteria và release gate cho **phần phát triển Orbit Multi-Agent theo Workspace**. Nó không thay thế yêu cầu Personal Agent trong [đề bài gốc](../PROJECT_REQUIREMENTS.md).
...
## 11. Snapshot triển khai tại thời điểm viết PRD

> Bảng dưới đây là snapshot lịch sử. Báo cáo hiện hành duy nhất là [Development Report](DEVELOPMENT_REPORT.md).
...
Golden cases và taxonomy chi tiết nằm tại [Multi-Agent Test Dataset](../../eval/datasets/MULTI_AGENT_DATASET.md).
...
## 16. Definition of Done cho release Workspace
...
- [Multi-Agent Test Dataset](../../eval/datasets/MULTI_AGENT_DATASET.md)
