# Đề bài gốc — AI Agent Trợ lý cá nhân trong Chat

> Tài liệu nguồn của dự án. Giữ nguyên yêu cầu nghiệp vụ; cách triển khai và phần Workspace mở rộng được mô tả ở các tài liệu khác.
