...
| AGENT-02 | Tóm tắt đúng ngữ cảnh, không bịa | `tests/test_agents/test_tools/test_summarize_tool.py` | `src/agents/tools/summarize_tool.py` | Acceptance dataset SUM cases | Covered; formal Agent gate failing |
